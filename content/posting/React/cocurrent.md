...
thumbnail: "/assets/thumbnails/react/6121df5b-8385-4bb8-9262-5b8a045965c3.png"
---
...
이번 포스팅에서는 그 해답이 되는 Concurrent React가 무엇인지, 왜 등장했는지 정리해보려 한다.
...
![기존 React 렌더링 방식](/assets/React/concurrent-rendering/synchronous-rendering-timeline.png)
...
![Concurrent Rendering 개념](/assets/React/concurrent-rendering/concurrent-rendering-overview.png)
...
![Concurrent vs Multi Thread](/assets/React/concurrent-rendering/concurrent-vs-multithread.png)
...
![Interruptible Rendering](/assets/React/concurrent-rendering/interruptible-rendering.png)
...
<interactive-demo
  src="/assets/React/concurrent-rendering/concurrent-rendering-demo.html"
...
![Fiber Tree 구조](/assets/React/concurrent-rendering/fiber-tree-structure.png)
...
![Priority Scheduling](/assets/React/concurrent-rendering/priority-scheduling.png)
...
![React Scheduler](/assets/React/concurrent-rendering/react-scheduler-flow.png)
...
![startTransition 동작](/assets/React/concurrent-rendering/start-transition-flow.png)
