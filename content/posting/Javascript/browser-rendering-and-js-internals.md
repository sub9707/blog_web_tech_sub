...
thumbnail: "/assets/thumbnails/javascript/browser-rendering-js-internals.jpg"
---
...
![브라우저 렌더링 파이프라인](/assets/Javascript/browser-rendering/browser-rendering-pipeline.png)
...
![DOM + CSSOM → Render Tree](/assets/Javascript/browser-rendering/dom-cssom-render-tree.png)
...
![V8 엔진 파이프라인](/assets/Javascript/browser-rendering/v8-engine-pipeline.png)
...
![V8 JIT 컴파일 흐름](/assets/Javascript/browser-rendering/v8-jit-compilation.png)
...
![V8 힙 메모리 구조](/assets/Javascript/browser-rendering/v8-heap-structure.png)
...
![파서 블로킹 타임라인](/assets/Javascript/browser-rendering/parser-blocking-timeline.png)
...
![async vs defer 비교](/assets/Javascript/browser-rendering/async-defer-comparison.png)
...
![Layout Thrashing 패턴](/assets/Javascript/browser-rendering/layout-thrashing.png)
