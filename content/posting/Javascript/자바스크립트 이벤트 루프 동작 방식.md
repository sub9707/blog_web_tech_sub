...
![브라우저 런타임 전체 구조](/assets/Javascript/event-loop-browser-overview.png)
...
![자바스크립트 런타임 간략도](/assets/Javascript/event-loop-runtime.png)
...
![콜 스택 쌓이는 과정](/assets/Javascript/event-loop-callstack.png)
...
![Web API로 setTimeout 위임](/assets/Javascript/event-loop-webapi.png)
...
![Callback Queue에 콜백 전달](/assets/Javascript/event-loop-taskqueue.png)
