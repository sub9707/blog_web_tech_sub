...
![Typescript IDE 에러](/assets/typescript/typescript-react-patterns/typescript-IDE-help.png)
...
![React HTML 속성 타입 상속 구조](/assets/typescript/typescript-react-patterns/react-html-attributes-hierarchy.png)
...
![제네릭 컴포넌트 T 타입 추론 흐름](/assets/typescript/typescript-react-patterns/generic-component-type-inference.png)
...
![Server Component와 Client Component 경계 — props 직렬화 가능 여부](/assets/typescript/typescript-react-patterns/server-client-boundary-props.png)
...
![React TypeScript 이벤트/props 타입 빠른 참조표](/assets/typescript/typescript-react-patterns/typescript-react-events-cheatsheet.png)
