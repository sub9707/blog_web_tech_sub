...
thumbnail: "/assets/thumbnails/typescript/enum-should-you-use-it.png"
---
...
![enum 컴파일 전후 비교](/assets/typescript/enum-should-you-use-it/compile-before-after.png)
...
![const enum과 isolatedModules 충돌 원리](/assets/typescript/enum-should-you-use-it/transpile-file-entire.png)
...
![enum vs as const 컴파일 결과 비교](/assets/typescript/enum-should-you-use-it/enum-vs-asconst.png)
