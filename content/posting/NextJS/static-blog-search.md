...
thumbnail: "/assets/thumbnails/nextjs/87a5fd11-58a0-4893-b26b-bec01be34fc4.png"
---
...
![search-index.json과 fuse.js 청크가 병렬로 로드되는 Network 탭](/assets/NextJS/static-blog-search/search-parallel-load.png)
...
![제목/설명/태그에 하이라이팅된 검색 결과 화면](/assets/NextJS/static-blog-search/search-highlight-result.png)
...
<!-- 이미지: 문제 발생 전후 비교 — 검색어 입력 시 결과가 없는 상태 vs 결과가 나오는 상태 캡처 | 파일명: search-ignore-location-before-after.png -->
...
![진짜 DB 검색 흐름 vs 빌드 타임 인덱스 흐름 비교](/assets/NextJS/static-blog-search/search-db-vs-file-index.png)
...
![빌드 타임과 런타임 흐름을 구분한 전체 아키텍처 다이어그램](/assets/NextJS/static-blog-search/search-architecture.png)
