...
![search-index.json과 fuse.js 청크가 병렬로 로드되는 Network 탭](/assets/NextJS/search-parallel-load.png)
...
![제목/설명/태그에 하이라이팅된 검색 결과 화면](/assets/NextJS/search-highlight-result.png)
...
![진짜 DB 검색 흐름 vs 빌드 타임 인덱스 흐름 비교](/assets/NextJS/search-db-vs-file-index.png)
...
![빌드 타임과 런타임 흐름을 구분한 전체 아키텍처 다이어그램](/assets/NextJS/search-architecture.png)
