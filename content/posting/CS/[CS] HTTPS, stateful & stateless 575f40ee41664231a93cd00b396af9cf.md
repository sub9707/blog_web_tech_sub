...
![SSL/TLS 핸드셰이크 과정](/assets/CS/https-tls-handshake.png)
...
![일대일 vs 다대일 통신 구조](/assets/CS/stateful-stateless-1to1.png)
...
![Stateless 설계의 수평 확장](/assets/CS/stateful-stateless-scalability.png)
...
![URI와 URL의 포함 관계](/assets/CS/uri-url-diagram.png)
