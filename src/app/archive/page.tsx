  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-16">
      <div className="max-w-xl">
        <h1 className="font-serif text-5xl font-bold text-gray-900 mb-2">Archive</h1>
                ...
                {months.map(({ num, label, count }) => (
                  <li key={num}>
                    <Link
                      ...
                      className="flex items-center justify-between py-2.5 border-b border-gray-50 hover:bg-gray-50 transition-colors px-1 group"
                    >
